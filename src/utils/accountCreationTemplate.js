...
const generateAccountCreationEmail = ({
  ...
  const safeName = escapeHtml(getValue(name, "Team Member"))
      ...
      <tr>
        <td align="center" style="padding:24px 12px;">
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;max-width:600px;border-collapse:separate;border-spacing:0;background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 12px 32px rgba(15,23,42,0.12);">
            <tr>
              <td align="center" style="padding:32px 24px;background:linear-gradient(180deg,#fffdfa 0%,${BRAND_SURFACE} 100%);border-bottom:1px solid #f3dfd7;">
                <img src="${escapeHtml(safeLogoUrl)}" alt="DT-Fusion360 Logo" width="104" style="display:block;max-width:104px;width:104px;height:auto;margin:0 auto 18px auto;border:0;outline:none;text-decoration:none;" />
                <div style="display:inline-block;padding:7px 14px;border-radius:999px;background-color:${BRAND_ACCENT};border:1px solid #f7d5be;font-size:12px;line-height:18px;font-weight:700;letter-spacing:0.04em;text-transform:uppercase;color:${BRAND_PRIMARY_DARK};">
                  DT-Fusion360 Account Setup
                </div>
                <div style="margin-top:16px;font-size:28px;line-height:36px;font-weight:700;color:#0f172a;">Welcome aboard, ${safeName}</div>
                <div style="margin-top:10px;font-size:15px;line-height:24px;color:#475569;max-width:440px;">
                  Your account is ready. Use the credentials below to sign in and complete your first login.
                </div>
              </td>
            </tr>
            <tr>
              <td style="padding:24px 24px 16px 24px;">
                <div style="margin-bottom:16px;padding:16px 18px;border-radius:16px;background-color:#fffaf8;border:1px solid #f2dfd5;font-size:15px;line-height:24px;color:#334155;">
                  Hello <strong style="color:#0f172a;">${safeName}</strong>,<br />
                  We're glad to have you on DT-Fusion360. Please keep these details secure and change your password after your first login.
                </div>
            ...
            <tr>
              <td align="center" style="padding:8px 24px 8px 24px;">
                <a href="${escapeHtml(safeLoginUrl)}" style="display:inline-block;padding:14px 28px;border-radius:999px;background:linear-gradient(135deg,${BRAND_PRIMARY} 0%,${BRAND_PRIMARY_DARK} 100%);color:#ffffff;font-size:15px;line-height:20px;font-weight:700;text-decoration:none;box-shadow:0 10px 18px rgba(237,28,36,0.24);">
                  Access Your Account
                </a>
              </td>
            </tr>
